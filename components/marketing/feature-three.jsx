...
const additionalFeatures = [
  {
    title: "Plug into your favorite tools.",
    description:
      "Build campaigns faster & 2X your results with reliable leads (no more ghosts).",
  },
  {
    title: "Discover companies all around the world.",
    description:
      "Sell to the big fish, the upcoming players, and the recently funded.",
  },
  {
    title: "Not just startup data.",
    description:
      "We're bringing social leads to Comb, so you can find your leads in places they hang out.",
  },
];
